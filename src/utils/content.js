...
import zksync from '../assets/images/section3/zksync.png';
...
export const section2Content = {
    items: [
      { counter: 383, subtitle: "Liquidity sources" },
      { counter: 286, before: "$", after: "B+", subtitle: "Total volume" },
      { counter: 4.5, after: "M+", subtitle: "Total wallets", decimals: true },
      { counter: 29.4, after: "M+", subtitle: "Total Trades", decimals: true },
    ],
};
